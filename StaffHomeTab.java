...
public class StaffHomeTab extends BorderPane {
    ...
    public StaffHomeTab(Stage primaryStage, Patient patient) {
    ...
    private void createTabs() {
        ...
        recordsTab.setContent(new Records(patient));
        diagnosisTab.setContent(new Diagnosis(patient));
        intakeTab.setContent(new PatientIntake(patient));
        messagesTab.setContent(new StaffMessaging(patient));
